...
export const BrainLayer: React.FC = () => {
  ...
  return (
    <section id="platform-section" className="relative py-24 bg-theme-bg border-t border-theme-border">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {capabilities.map((cap, idx) => (
              <div key={idx} className="premium-card p-6 space-y-3">
                <div className="w-10 h-10 rounded-xl bg-theme-bgTertiary border border-theme-border flex items-center justify-center relative shadow-sm overflow-hidden group-hover:scale-110 transition-transform shrink-0">
            ...
            <div className="glass-card rounded-3xl p-6 relative overflow-hidden shadow-md">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <span className="text-xs font-bold text-theme-textMuted uppercase tracking-widest block">Incoming Input Event</span>
                  <div className="p-3 bg-theme-bg border border-theme-border rounded-xl font-mono text-xs md:text-sm text-theme-text leading-normal">
                    {simulatedTriggers[activeTab].incoming}
                  </div>
                </div>
 
                <div className="space-y-1.5">
                  <span className="text-xs font-bold text-theme-textMuted uppercase tracking-widest block">AI Brain Reasoning Log</span>
                  <div className="p-3.5 bg-theme-bgAlt border border-theme-border rounded-xl space-y-1 font-mono text-xs md:text-sm text-brand-teal leading-relaxed min-h-[120px]">
