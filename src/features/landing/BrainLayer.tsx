...
export const BrainLayer: React.FC = () => {
  ...
  return (
    <section id="platform-section" className="relative py-24 bg-[#F7FDF9] border-t border-zinc-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {capabilities.map((cap, idx) => (
              <div key={idx} className="premium-card p-6 space-y-3">
                <div className="w-10 h-10 rounded-xl bg-white border border-zinc-200 flex items-center justify-center relative shadow-sm overflow-hidden group-hover:scale-110 transition-transform shrink-0">
                  <div className="absolute inset-0 bg-brand-gradient opacity-10" />
                  <span className="relative z-10 shrink-0">{cap.icon}</span>
                </div>
                <h3 className="text-lg font-black text-[#1A1A2E]">{cap.title}</h3>
                <p className="text-zinc-500 text-sm font-semibold leading-relaxed">{cap.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="glass-card rounded-3xl p-6 border border-zinc-200 bg-white relative overflow-hidden shadow-md">
              <div className="absolute top-0 left-0 right-0 h-[1px] bg-brand-gradient opacity-30" />
              
              <div className="text-sm font-medium text-zinc-500 tracking-wider uppercase mb-5 flex justify-between items-center">
              ...
              {/* Tabs inside Visual */}
              <div className="flex gap-2 p-1 bg-zinc-50 rounded-xl mb-6">
                {[
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="p-3 bg-[#F7FDF9] border border-zinc-200 rounded-xl font-mono text-xs md:text-sm text-zinc-700 leading-normal">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="p-3.5 bg-zinc-50 border border-zinc-200 rounded-xl font-mono text-xs md:text-sm text-zinc-800 flex items-start gap-2">
                    <div className="w-4 h-4 rounded-full bg-[#DCF8C6] flex items-center justify-center text-[#128C7E] shrink-0 mt-0.5">
