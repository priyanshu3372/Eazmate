    ...
    <div className="bg-theme-bg text-theme-textMuted min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 text-center relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mt-12">
          {[
            { value: "Omnichannel", label: "Unified Messages", icon: <Users className="w-4 h-4 text-purple-600 dark:text-purple-400" />, color: "text-purple-600 dark:text-purple-400" },
            { value: "No-Code", label: "Workflow Builder", icon: <Zap className="w-4 h-4 text-blue-600 dark:text-blue-400" />, color: "text-blue-600 dark:text-blue-400" },
            { value: "SOC 2", label: "Compliance Logging", icon: <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />, color: "text-emerald-600 dark:text-emerald-400" },
            { value: "94%", label: "Manual Lag Cut", icon: <Layers className="w-4 h-4 text-teal-600 dark:text-teal-400" />, color: "text-teal-600 dark:text-teal-400" }
          ].map((stat, idx) => (
